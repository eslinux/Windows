...
#ifndef soapdimeService_H
#define soapdimeService_H
#include "soapH.h"
class SOAP_CMAC dimeService : public soap
{ public:
	/// Variables globally declared in dime.h (non-static)
	/// Constructor
	dimeService();
	/// Construct from another engine state
	dimeService(const struct soap&);
	/// Constructor with engine input+output mode control
	dimeService(soap_mode iomode);
	/// Constructor with engine input and output mode control
	dimeService(soap_mode imode, soap_mode omode);
	...
	virtual	void dimeService_init(soap_mode imode, soap_mode omode);
	/// Create a copy
	virtual	dimeService *copy() SOAP_PURE_VIRTUAL;
