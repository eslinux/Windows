// StatusNetworkExternal.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(StatusNetworkExternal, CDialogEx)

StatusNetworkExternal::StatusNetworkExternal(CWnd* pParent /*=NULL*/)
	: CDialogEx(StatusNetworkExternal::IDD, pParent)
	, m_incomeMax(_T(""))
	, m_incomeAvg(_T(""))
	, m_incomeMin(_T(""))
	, m_incomeCurrent(_T(""))
...
void StatusNetworkExternal::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_COMBO_GRAPH_MODE, m_graphTime);
	DDX_Control(pDX, IDC_STATIC_EXTERNAL_GRAPH, m_graphTool);
...
BEGIN_MESSAGE_MAP(StatusNetworkExternal, CDialogEx)
	ON_WM_SIZE()
	ON_WM_PAINT()
	ON_WM_SHOWWINDOW()
	ON_WM_TIMER()
	ON_CBN_SELCHANGE(IDC_COMBO_GRAPH_MODE, &StatusNetworkExternal::OnCbnSelchangeComboGraphMode)
END_MESSAGE_MAP()


// StatusNetworkExternal message handlers


void StatusNetworkExternal::OnSize(UINT nType, int cx, int cy)
{
...
BOOL StatusNetworkExternal::OnInitDialog()
{
...
void StatusNetworkExternal::OnOK()
{
...
void StatusNetworkExternal::OnPaint()
{
...
void StatusNetworkExternal::OnShowWindow(BOOL bShow, UINT nStatus)
{
...
void StatusNetworkExternal::OnTimer(UINT_PTR nIDEvent)
{
	// TODO: Add your message handler code here and/or call default
	if(nIDEvent == TIMER_IDEVENT_DEFAULT){

		//update
		if(ctSoapEngine.getStatusNetworkExternal(m_graphTool.m_graphMode, &m_networkData)){
			//update current list if
			TRACE(L"StatusNetworkExternal::OnTimer update\n");

		}else{
			//clear all current list if
			TRACE(L"StatusNetworkExternal::OnTimer clear\n");
...
void StatusNetworkExternal::OnCbnSelchangeComboGraphMode()
{
